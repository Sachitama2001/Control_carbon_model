...
平衡構造、安定性変化、履歴依存性、または rate-induced tipping 等のダイナミクスの特徴が
...
> 平衡構造、安定性変化、吸引域移動、経路依存性、または R-tipping 等のダイナミクスの特徴が、
...
- できるだけ、2次元または3次元の相図によって視覚的にダイナミクスの軌道がわかりやすい図を各項目ごとに出力しておく
